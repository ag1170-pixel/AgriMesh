...
// code -> pesticide {en, hi} (generated by model/gen_pesticides.py; no value has a comma)
const PESTICIDE = Object.fromEntries(
  fs.readFileSync(path.join(__dirname, "pesticides.csv"), "utf-8")
    .trim().split(/\r?\n/).slice(1)

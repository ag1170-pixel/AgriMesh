...
md("## 10. Export to TensorFlow.js + download\n",
   "Produces `web_model.zip` containing `model.json`, `*.bin`, and `labels.json`.\n",
   "**Unzip its contents into `frontend/models/`** — the app auto-detects `model.json`,\n",
   "no code change needed."),
code("import os\n",
     "os.environ['TF_USE_LEGACY_KERAS'] = '1'  # tfjs converter needs Keras 2\n",
     "import tensorflowjs as tfjs, shutil\n",
     "OUT = '/content/web_model'\n",
     "tfjs.converters.save_keras_model(model, OUT)\n",
     "shutil.copy('/content/labels.json', os.path.join(OUT, 'labels.json'))\n",
